...
void handleReflowNav() {
  ...
  message += F("  <a href=/oven target=bottom>Oven Mode</a> | \n"); // fng
...
void handleJSONOven () {
  ...
  message += "{\n";
  message += "  \"data\" : {\n";
  message += "    \"Temperatura\" : " + String(float((sensorA+sensorB)/2)) + ",\n";
  message += "    \"Tiempo\" : " + String(millis()/1000) + ",\n";
  message += "    \"Setpoint\" : " + String(Setpoint) + ",\n";
  message += "    \"systemMessage\" : \"" + String(systemMessage) + "\"\n";
  message += "  },\n";
  message += " \"status\" : \"ok\"\n";
...
void handleReflowChart() {
  ...
  message += "    document.chartForm.processOutput.value = res.data.Output;\n";
  ...
  message += "  Hysteresis  <input name='processTempHysteresis' type='text' id='textfield13' size='1' maxlength='1' value='" + String(processTempHysteresis) + "'/>\n";
  message += "  Out  <input name='processOutput' type='text' id='textfield13' size='1' maxlength='3' value='" + String(Output) + "'/><br>\n";
...
void handleOven(){
  ...
  message += "    res=JSON.parse(res);\n";
  message += "    if(res.status=='ok'){\n";
  message += "    document.getElementById('Temperatura').innerHTML = res.data.Temperatura;\n";
  message += "    document.getElementById('Tiempo').innerHTML = res.data.Tiempo;\n";
  message += "    document.getElementById('Setpoint').innerHTML = res.data.Setpoint;\n";
  message += "    }\n";
  message += "  }\n";
  message += "}\n";
  message += "xmlhttp.open('GET','/json/oven',true);\n";
  message += "xmlhttp.send();\n";
  message += "}\n";
  message += "</script>\n";
  ...
  message += "</head>\n";
  message += "<body>\n";
  //  message += "<h2>Oven Mode</h2>\n";


  message += " <div style='text-align: center'>";
  message += " <div style='font-size: 40pt; color: #000;'>Actual:</div> \n";
  message += " <p></p>\n";
    message += " <p></p>\n";
  message += " <div id='Temperatura' style='font-size: 40pt; color: #000;'></div> \n";
  message += " <p></p>\n";
    message += " <p></p>\n";
  message += " <div style='font-size: 40pt; color: #000;'>Setpoint</div> \n";
  message += " <p></p>\n";
    message += " <p></p>\n";
  message += " <div id='Setpoint' style='font-size: 40pt; color: #000;'>180</div> \n";
  message += " <p></p>\n";
    message += " <p></p>\n";
  message += " <div style='font-size: 40pt; color: #000;'>Tiempo</div> \n";
  message += " <p></p>\n";
    message += " <p></p>\n";
  message += " <div id='Tiempo' style='font-size: 40pt; color: #000;'>180</div> \n";    
  message += " <p></p>\n";  
    message += " <p></p>\n";
  message += " /<div>";  
